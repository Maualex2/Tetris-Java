public class IA {
    ...
    public void joue1Coup() { // Calcul le meilleur coup sur le terrain actuel
        ...
        for (int nbRotationsDroite = 0; nbRotationsDroite <= 3; ++nbRotationsDroite) { // Iterere toutes les rotations
                                                                                       // possibles
    ...
    public int evaluation(TerrainDeJeu f) {
        ...
        return f.points + (f.EnJeu.Coordonnees[0][1] + f.hauteur) + (f.EnJeu.Coordonnees[1][1] + f.hauteur)
                + (f.EnJeu.Coordonnees[2][1] + f.hauteur) + (f.EnJeu.Coordonnees[3][1] + f.hauteur);
    }
